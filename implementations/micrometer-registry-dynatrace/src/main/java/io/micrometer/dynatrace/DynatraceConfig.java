...
public interface DynatraceConfig extends StepRegistryConfig {
    ...
    /**
     * Intercept WARN messages generated by the Dynatrace registry and log them at INFO
     * instead. This will reduce the WARN log volume generated by telemetry data exports
     * in order to not hide business logic output.
     * @return true if the logs should be intercepted and logged at INFO instead, false
     * otherwise.
     */
    ...
    /**
     * Intercept ERROR messages generated by the Dynatrace registry and log them at INFO
     * instead. This will reduce the ERROR log volume generated by telemetry data exports
     * in order to not hide business logic output.
     * @return true if the logs should be intercepted and logged at INFO instead, false
     * otherwise.
     */
